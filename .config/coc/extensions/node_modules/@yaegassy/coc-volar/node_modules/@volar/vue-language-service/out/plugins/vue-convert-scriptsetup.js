...
function useSetupSugar(ts, document, vueSourceFile, context, doCodeActions, doCodeActionResolve) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!sfc.scriptAst)
            return;
        const edits = yield getEdits(document, sfc.script, sfc.scriptAst);
        if (edits === null || edits === void 0 ? void 0 : edits.length) {
            yield context.applyEdit({ changes: { [document.uri]: edits } });
            yield shared.sleep(200);
            const importEdits = yield getAddMissingImportsEdits(document, doCodeActions, doCodeActionResolve);
            if (importEdits) {
                yield context.applyEdit(importEdits);
            }
        }
        function getEdits(document, _script, _scriptAst) {
            return __awaiter(this, void 0, void 0, function* () {
                const ranges = vue_language_core_1.scriptSetupConvertRanges.parseUseScriptSetupRanges(ts, _scriptAst);
                const edits = [];
...
function unuseSetupSugar(ts, document, vueSourceFile, context, doCodeActions, doCodeActionResolve) {
    return __awaiter(this, void 0, void 0, function* () {
        const sfc = vueSourceFile.sfc;
        if (!sfc.scriptSetup)
            return;
        if (!sfc.scriptSetupAst)
            return;
        const edits = yield getEdits(document, sfc.script, sfc.scriptSetup, sfc.scriptAst, sfc.scriptSetupAst);
        if (edits === null || edits === void 0 ? void 0 : edits.length) {
            yield context.applyEdit({ changes: { [document.uri]: edits } });
            yield shared.sleep(200);
            const importEdits = yield getAddMissingImportsEdits(document);
            if (importEdits) {
                yield context.applyEdit(importEdits);
            }
        }
        function getAddMissingImportsEdits(document) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
        ...
        function getEdits(document, _script, _scriptSetup, _scriptAst, _scriptSetupAst) {
            var _a, _b, _c, _d;
            return __awaiter(this, void 0, void 0, function* () {
                const ranges = vue_language_core_1.scriptSetupConvertRanges.parseUnuseScriptSetupRanges(ts, _scriptSetupAst);
                const scriptRanges = _scriptAst ? vue_language_core_1.scriptSetupConvertRanges.parseUseScriptSetupRanges(ts, _scriptAst) : undefined;
                const edits = [];
...
function getAddMissingImportsEdits(document, doCodeActions, doCodeActionResolve) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const codeActions = (_a = yield doCodeActions(document.uri, {
            start: document.positionAt(0),
