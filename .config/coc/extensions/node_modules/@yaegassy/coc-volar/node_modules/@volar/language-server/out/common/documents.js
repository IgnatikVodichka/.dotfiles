...
class IncrementalScriptSnapshot {
            ...
            const snapshot = {
                ...
                getChangeRange: (oldSnapshot) => {
                    if (!cache.has(oldSnapshot)) {
                        const oldIndex = this.changes.findIndex(change => { var _a; return ((_a = change.snapshot) === null || _a === void 0 ? void 0 : _a.deref()) === oldSnapshot; });
                        if (oldIndex >= 0) {
    ...
    clearUnReferenceVersions() {
        ...
        for (let i = 0; i <= this.changes.length - 2; i++) {
            ...
            if (!((_a = change.snapshot) === null || _a === void 0 ? void 0 : _a.deref())) {
...
function createDocuments(connection) {
