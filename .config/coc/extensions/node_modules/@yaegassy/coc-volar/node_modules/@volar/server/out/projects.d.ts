...
export declare function createProjects(rootPaths: string[], ts: typeof import('typescript/lib/tsserverlibrary'), tsLocalized: ts.MapLike<string> | undefined, options: shared.ServerInitializationOptions, documents: vscode.TextDocuments<TextDocument>, connection: vscode.Connection, lsConfigs: ReturnType<typeof createLsConfigs> | undefined, inferredCompilerOptions: ts.CompilerOptions): {
    workspaces: Map<string, {
        projects: {
            ...
            fsPathGet: (_fsPath: string) => Promise<{
                onWorkspaceFilesChanged: (changes: vscode.FileEvent[]) => Promise<void>;
                onDocumentUpdated: (document: TextDocument) => Promise<void>;
                getLanguageService: () => Promise<{
                    doValidation: (uri: string, response?: ((result: vscode.Diagnostic[]) => void) | undefined, isCancel?: (() => Promise<boolean>) | undefined) => Promise<Promise<vscode.Diagnostic[] | undefined>>;
            ...
            fsPathSet: (_fsPath: string, item: Promise<{
                onWorkspaceFilesChanged: (changes: vscode.FileEvent[]) => Promise<void>;
                onDocumentUpdated: (document: TextDocument) => Promise<void>;
                getLanguageService: () => Promise<{
                    doValidation: (uri: string, response?: ((result: vscode.Diagnostic[]) => void) | undefined, isCancel?: (() => Promise<boolean>) | undefined) => Promise<Promise<vscode.Diagnostic[] | undefined>>;
        ...
        getProjectByCreate: (tsConfig: string) => Promise<{
            onWorkspaceFilesChanged: (changes: vscode.FileEvent[]) => Promise<void>;
            onDocumentUpdated: (document: TextDocument) => Promise<void>;
            getLanguageService: () => Promise<{
                doValidation: (uri: string, response?: ((result: vscode.Diagnostic[]) => void) | undefined, isCancel?: (() => Promise<boolean>) | undefined) => Promise<Promise<vscode.Diagnostic[] | undefined>>;
