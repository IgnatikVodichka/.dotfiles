...
function register(context) {
    ...
    function transformCallHierarchyItem(tsItem, tsRanges) {
        ...
        for (const [_, map] of context.documents.getMapsByVirtualFileUri(tsItem.uri)) {
            ...
            const vueItem = Object.assign(Object.assign({}, tsItem), { name: tsItem.name === path_1.posix.basename(shared.getPathOfUri(map.virtualFileDocument.uri)) ? path_1.posix.basename(shared.getPathOfUri(map.sourceFileDocument.uri)) : tsItem.name, uri: map.sourceFileDocument.uri, 
