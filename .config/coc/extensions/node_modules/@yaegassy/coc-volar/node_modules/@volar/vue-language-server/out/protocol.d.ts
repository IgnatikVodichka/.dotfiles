...
export declare namespace GetVueCompilerOptionsRequest {
    type ParamsType = vscode.TextDocumentIdentifier;
    type ResponseType = any | null | undefined;
    type ErrorType = never;
    const type: vscode.RequestType<vscode.TextDocumentIdentifier, any, never>;
}
