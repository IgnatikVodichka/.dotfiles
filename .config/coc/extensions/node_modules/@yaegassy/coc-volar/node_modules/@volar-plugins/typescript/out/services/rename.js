...
function register(rootUri, languageService, getTextDocument, getConfiguration) {
    return (uri, position, newName) => __awaiter(this, void 0, void 0, function* () {
        ...
        const { providePrefixAndSuffixTextForRename } = yield (0, getUserPreferences_1.getUserPreferences)(getConfiguration, document.uri, rootUri);
    ...
    function renameFile(fileToRename, newName, formatOptions, preferences) {
        ...
        edits.documentChanges.push(vscode.RenameFile.create(shared.getUriByPath(fileToRename), shared.getUriByPath(newFilePath)));
        return edits;
    }
}
