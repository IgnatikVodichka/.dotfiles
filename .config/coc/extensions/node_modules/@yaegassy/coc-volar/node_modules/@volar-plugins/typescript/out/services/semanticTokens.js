...
function register(host, languageService, getTextDocument, ts) {
    return (uri, range, legend) => {
        ...
        if ((_a = host.getCancellationToken) === null || _a === void 0 ? void 0 : _a.call(host).isCancellationRequested())
            return;
        let response2;
        try {
        ...
        if (!response2)
            return;
        if ((_b = host.getCancellationToken) === null || _b === void 0 ? void 0 : _b.call(host).isCancellationRequested())
            return;
        let response1;
        try {
