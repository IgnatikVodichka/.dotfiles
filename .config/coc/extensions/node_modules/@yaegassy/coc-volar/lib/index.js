  ...
  (function(ResolvedMessageReaderOptions2) {
    function fromOptions(options) {
      ...
      if (options === void 0 || typeof options === "string") {
        ...
        charset = (_a3 = options.charset) !== null && _a3 !== void 0 ? _a3 : "utf-8";
  ...
  (function(ResolvedMessageWriterOptions2) {
    function fromOptions(options) {
      ...
      if (options === void 0 || typeof options === "string") {
        ...
        return {charset: (_a3 = options.charset) !== null && _a3 !== void 0 ? _a3 : "utf-8", contentEncoder: options.contentEncoder, contentTypeEncoder: (_b = options.contentTypeEncoder) !== null && _b !== void 0 ? _b : ral_1.default().applicationJson.encoder};
      }
    }
...
var require_requests = __commonJS((exports2) => {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {value: true});
  exports2.DetectDocumentNameCasesRequest = exports2.WriteVirtualFilesNotification = exports2.VerifyAllScriptsNotification = exports2.GetRefCompleteEditsRequest = exports2.GetTagCloseEditsRequest = exports2.D3Request = exports2.GetMatchTsConfigRequest = exports2.DepsRequest = exports2.InitDoneRequest = exports2.GetEditorSelectionRequest = exports2.GetDocumentPrintWidthRequest = exports2.GetDocumentNameCasesRequest = exports2.ShowReferencesNotification = exports2.GetDocumentVersionRequest = exports2.GetDocumentContentRequest = void 0;
  ...
  (function(GetDocumentVersionRequest3) {
    GetDocumentVersionRequest3.type = new rpc.RequestType("vue/docVersion");
  ...
  var DepsRequest;
  (function(DepsRequest2) {
    DepsRequest2.type = new rpc.RequestType0("volar/depFiles");
  })(DepsRequest = exports2.DepsRequest || (exports2.DepsRequest = {}));
...
var require_ts = __commonJS((exports2) => {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {value: true});
  exports2.createParsedCommandLine = exports2.getTypeScriptVersion = exports2.getVscodeTypescriptLocalizedPath = exports2.getVscodeTypescriptPath = exports2.findTypescriptLocalizedPathInLib = exports2.findTypescriptModulePathInLib = exports2.getWorkspaceTypescriptLocalizedPath = exports2.getWorkspaceTypescriptPath = exports2.createTsLanguageService = exports2.getTsCompletions = void 0;
  var fs4 = require("fs");
  ...
  function createParsedCommandLine(ts, parseConfigHost, tsConfig, extendsSet = new Set()) {
    ...
    let baseVueOptions = {};
    const folder = path4.dirname(tsConfig);
    ...
    return {
      ...
      vueOptions: {
        ...baseVueOptions,
        ...resolveVueCompilerOptions((_a3 = content.raw.vueCompilerOptions) !== null && _a3 !== void 0 ? _a3 : {}, folder)
      }
    };
  }
  ...
  function resolveVueCompilerOptions(rawOptions, rootPath) {
    ...
    if (templateOptionsPath) {
      if (!path4.isAbsolute(templateOptionsPath)) {
...
// node_modules/@volar/shared/out/vue.js
var require_vue = __commonJS((exports2) => {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {value: true});
  ...
  function parseSfc2(text, doc) {
    ...
    for (const node of doc.roots) {
      ...
      const lang = (_a3 = node.attributes) === null || _a3 === void 0 ? void 0 : _a3["lang"];
...
var require_out = __commonJS((exports2) => {
  ...
  Object.defineProperty(exports2, "__esModule", {value: true});
  exports2.getDocumentSafely = exports2.eqSet = exports2.getOverlapRange = exports2.getWordRange = exports2.isInsideRange = exports2.notEmpty = exports2.languageIdToSyntax = exports2.syntaxToLanguageId = exports2.sleep = void 0;
  ...
  __exportStar2(require_vue(), exports2);
  var vscode_uri_1 = require_esm();
  var util_1 = require("util");
  exports2.sleep = (0, util_1.promisify)(setTimeout);
  ...
  function notEmpty3(value) {
    return value !== null && value !== void 0;
  }
  exports2.notEmpty = notEmpty3;
  ...
  function getDocumentSafely(documents, uri) {
    ...
    const document = (_a3 = documents.get(uri)) !== null && _a3 !== void 0 ? _a3 : documents.get(normalizeUri);
    if (document) {
      return document;
    }
    for (const document2 of documents.all()) {
      if (vscode_uri_1.URI.parse(document2.uri).toString() === normalizeUri) {
        return document2;
      }
    }
  }
  exports2.getDocumentSafely = getDocumentSafely;
});
...
var require_main2 = __commonJS((exports2) => {
  ...
  __export(exports2, {
    ...
    CodeActionContext: () => CodeActionContext3,
  ...
  (function(Location4) {
    ...
    function is(value) {
      var candidate = value;
      return Is2.defined(candidate) && Range6.is(candidate.range) && (Is2.string(candidate.uri) || Is2.undefined(candidate.uri));
    }
    Location4.is = is;
  })(Location3 || (Location3 = {}));
  var LocationLink2;
  (function(LocationLink3) {
    ...
    function is(value) {
      var candidate = value;
      return Is2.defined(candidate) && Range6.is(candidate.targetRange) && Is2.string(candidate.targetUri) && (Range6.is(candidate.targetSelectionRange) || Is2.undefined(candidate.targetSelectionRange)) && (Range6.is(candidate.originSelectionRange) || Is2.undefined(candidate.originSelectionRange));
    }
    LocationLink3.is = is;
  ...
  (function(ColorInformation3) {
    ...
    function is(value) {
      var candidate = value;
      return Range6.is(candidate.range) && Color2.is(candidate.color);
    }
  ...
  (function(ColorPresentation3) {
    ...
    function is(value) {
      var candidate = value;
      return Is2.string(candidate.label) && (Is2.undefined(candidate.textEdit) || TextEdit3.is(candidate)) && (Is2.undefined(candidate.additionalTextEdits) || Is2.typedArray(candidate.additionalTextEdits, TextEdit3.is));
    }
  ...
  var TextEditChangeImpl2 = function() {
  ...
  var ChangeAnnotations2 = function() {
  ...
  })(CodeActionContext3 || (CodeActionContext3 = {}));
  var CodeAction3;
  ...
  (function(SelectionRange3) {
    ...
    function is(value) {
      var candidate = value;
      return candidate !== void 0 && Range6.is(candidate.range) && (candidate.parent === void 0 || SelectionRange3.is(candidate.parent));
    }
  ...
  (function(TextDocument7) {
    ...
    TextDocument7.applyEdits = applyEdits;
  ...
  })(TextDocument6 || (TextDocument6 = {}));
  var FullTextDocument3 = function() {
...
var require_main4 = __commonJS((exports2) => {
  ...
  function initializeSettings() {
    ...
    if (isString2(process.env.VSCODE_NLS_CONFIG)) {
      try {
        ...
        if (isString2(vscodeOptions_1.locale)) {
        ...
        if (isString2(vscodeOptions_1._cacheRoot)) {
          options.cacheRoot = vscodeOptions_1._cacheRoot;
        }
        if (isString2(vscodeOptions_1._languagePackId)) {
          options.languagePackId = vscodeOptions_1._languagePackId;
        }
        if (isString2(vscodeOptions_1._translationsConfigFile)) {
          options.translationsConfigFile = vscodeOptions_1._translationsConfigFile;
          try {
            options.translationsConfig = readJsonFileSync(options.translationsConfigFile);
          } catch (error) {
            if (vscodeOptions_1._corruptedFile) {
              var dirname = path4.dirname(vscodeOptions_1._corruptedFile);
              fs4.exists(dirname, function(exists) {
                if (exists) {
  ...
  function findInTheBoxBundle(root) {
    ...
    while (language) {
      var candidate = path4.join(root, "nls.bundle." + language + ".json");
    ...
    for (var module_2 in metaData) {
      ...
      if (translations) {
        ...
        for (var i = 0; i < entry.keys.length; i++) {
          ...
          var key = isString2(messageKey) ? messageKey : messageKey.key;
  ...
  function loadNlsBundleOrCreateFromI18n(header, bundlePath) {
    var result;
    var bundle = path4.join(options.cacheRoot, header.id + "-" + header.hash + ".json");
  ...
  function tryFindMetaDataHeaderFile(file) {
    var result;
    var dirname = path4.dirname(file);
    while (true) {
      result = path4.join(dirname, "nls.metadata.header.json");
      if (fs4.existsSync(result)) {
        break;
      }
      var parent = path4.dirname(dirname);
      if (parent === dirname) {
        result = void 0;
        break;
      } else {
...
var shared4 = __toModule(require_out());
...
function activateTagClosing(tagProvider, supportedLanguages, configName) {
  ...
  async function updateEnabledState() {
    ...
    if (!import_coc4.workspace.getConfiguration(void 0, document.uri).get(configName)) {
      return;
    }
    isEnabled = true;
  }
  async function onDidChangeTextDocument(document, changes) {
    ...
    const rangeStart = "range" in lastChange ? lastChange.range.start : coc2.Position.create(0, document.getText().length);
    ...
    timeout = setTimeout(async () => {
      ...
      await tagProvider(document, position).then(async (text) => {
        if (text && isEnabled) {
          ...
          if (document.uri === activeDocument2.uri && activeDocument2.version === version) {
            if (text.startsWith("$")) {
...
async function activate5(context, tsClient) {
  ...
  context.subscriptions.push(activateTagClosing2((document, position) => {
    const param = {
      textDocument: {uri: document.uri},
      position
    };
...
function activateTagClosing2(tagProvider, supportedLanguages, configName) {
  ...
  async function updateEnabledState() {
    ...
    if (!import_coc5.workspace.getConfiguration(void 0, document.uri).get(configName)) {
      return;
    }
    isEnabled = true;
  }
  async function onDidChangeTextDocument(document, changes) {
    ...
    const rangeStart = "range" in lastChange ? lastChange.range.start : coc3.Position.create(0, document.getText().length);
    const version = document.version;
    timeout = setTimeout(async () => {
...
var nls = __toModule(require_main4());
...
(function(Range6) {
  function create(one, two, three, four) {
    if (Is.uinteger(one) && Is.uinteger(two) && Is.uinteger(three) && Is.uinteger(four)) {
      return {start: Position6.create(one, two), end: Position6.create(three, four)};
    } else if (Position6.is(one) && Position6.is(two)) {
      return {start: one, end: two};
    } else {
      throw new Error("Range#create called with invalid arguments[" + one + ", " + two + ", " + three + ", " + four + "]");
    }
  ...
  function is(value) {
    var candidate = value;
    return Is.objectLiteral(candidate) && Position6.is(candidate.start) && Position6.is(candidate.end);
  }
  Range6.is = is;
})(Range4 || (Range4 = {}));
var Location2;
...
(function(LocationLink2) {
  ...
  function is(value) {
    var candidate = value;
    return Is.defined(candidate) && Range4.is(candidate.targetRange) && Is.string(candidate.targetUri) && (Range4.is(candidate.targetSelectionRange) || Is.undefined(candidate.targetSelectionRange)) && (Range4.is(candidate.originSelectionRange) || Is.undefined(candidate.originSelectionRange));
  }
  LocationLink2.is = is;
...
(function(ColorInformation2) {
  ...
  function is(value) {
    var candidate = value;
    return Range4.is(candidate.range) && Color.is(candidate.color);
  }
...
(function(SelectionRange2) {
  ...
  function is(value) {
    var candidate = value;
    return candidate !== void 0 && Range4.is(candidate.range) && (candidate.parent === void 0 || SelectionRange2.is(candidate.parent));
  }
...
var FullTextDocument = function() {
  ...
  FullTextDocument3.prototype.positionAt = function(offset) {
    ...
    var low = 0, high = lineOffsets.length;
    if (high === 0) {
      return Position6.create(0, offset);
    }
    while (low < high) {
      var mid = Math.floor((low + high) / 2);
      if (lineOffsets[mid] > offset) {
    ...
    var line = low - 1;
    return Position6.create(line, offset - lineOffsets[line]);
  };
...
var nls2 = __toModule(require_main4());
...
function pathToReplaceRange(valueBeforeCursor, fullValue, range) {
  ...
  if (lastIndexOfSlash === -1) {
    ...
    replaceRange = Range4.create(startPos, endPos);
  }
  return replaceRange;
}
...
var HTMLCompletion = function() {
  ...
  HTMLCompletion2.prototype._doComplete = function(document, position, htmlDocument, settings) {
    ...
    function collectCharacterEntityProposals() {
      ...
      if (k >= 0 && text[k] === "&") {
        var range = Range4.create(Position6.create(position.line, characterStart - 1), position);
...
var nls3 = __toModule(require_main4());
  ...
  HTMLHover2.prototype.doHover = function(document, position, htmlDocument, options) {
    ...
    function getEntityRange() {
      ...
      if (k >= 0 && text[k] === "&") {
        var range = null;
        if (text[n] === ";") {
          range = Range4.create(Position6.create(position.line, characterStart), Position6.create(position.line, characterEnd + 1));
        } else {
          range = Range4.create(Position6.create(position.line, characterStart), Position6.create(position.line, characterEnd));
        }
        return range;
      }
      return null;
...
function format(document, range, options) {
  ...
  if (range) {
    ...
    range = Range4.create(document.positionAt(startOffset), document.positionAt(endOffset));
    ...
    value = value.substring(startOffset, endOffset);
    if (startOffset !== 0) {
      var startOfLineOffset = document.offsetAt(Position6.create(range.start.line, 0));
      initialIndentLevel = computeIndentLevel(document.getText(), startOfLineOffset, options);
    }
  } else {
    range = Range4.create(Position6.create(0, 0), document.positionAt(value.length));
  }
  var htmlOptions = {
    indent_size: tabSize,
...
var import_vscode_uri = require_esm();
...
function isValidURI(uri) {
  try {
    import_vscode_uri.URI.parse(uri);
    return true;
  } catch (e) {
    return false;
  }
...
function provideFileSymbolsInternal(document, node, container, symbols) {
  ...
  var location = Location2.create(document.uri, Range4.create(document.positionAt(node.start), document.positionAt(node.end)));
  var symbol = {
    name,
    location,
...
function findLinkedEditingRanges(document, position, htmlDocument) {
  ...
  if (node.start + "<".length <= offset && offset <= node.start + "<".length + tagLength || node.endTagStart + "</".length <= offset && offset <= node.endTagStart + "</".length + tagLength) {
    return [
      Range4.create(document.positionAt(node.start + "<".length), document.positionAt(node.start + "<".length + tagLength)),
      Range4.create(document.positionAt(node.endTagStart + "</".length), document.positionAt(node.endTagStart + "</".length + tagLength))
    ];
  }
  return null;
}
  ...
  function getSelectionRange(position) {
    ...
    for (var index = applicableRanges.length - 1; index >= 0; index--) {
      ...
      if (!prev || range[0] !== prev[0] || range[1] !== prev[1]) {
        current = SelectionRange.create(Range4.create(document.positionAt(applicableRanges[index][0]), document.positionAt(applicableRanges[index][1])), current);
      }
      prev = range;
    }
    if (!current) {
      current = SelectionRange.create(Range4.create(position, position));
    }
    return current;
  }
...
function getApplicableRanges(document, position) {
  ...
  if (currNode.startTagEnd && !currNode.endTagStart) {
    ...
    var closeRange = Range4.create(document.positionAt(currNode.startTagEnd - 2), document.positionAt(currNode.startTagEnd));
...
function getAttributeLevelRanges(document, currNode, currOffset) {
  var currNodeRange = Range4.create(document.positionAt(currNode.start), document.positionAt(currNode.end));
...
function activate6(context) {
  ...
  async function onSplit() {
    ...
    if (scriptBlocks.length >= 1) {
      await import_coc6.workspace.jumpTo(doc.textDocument.uri, import_coc6.Position.create(scriptBlocks[0].start, scriptBlocks[0].end));
    ...
    if (templateBlocks.length >= 1) {
      await import_coc6.workspace.jumpTo(doc.textDocument.uri, import_coc6.Position.create(templateBlocks[0].start, templateBlocks[0].end));
      if (scriptBlocks.length >= 1)
    ...
    if (styleBlocks.length >= 1) {
      await import_coc6.workspace.jumpTo(doc.textDocument.uri, import_coc6.Position.create(styleBlocks[0].start, styleBlocks[0].end));
      if (scriptBlocks.length >= 1)
        await foldingSFCBlock(scriptBlocks);
      if (templateBlocks.length >= 1)
        await foldingSFCBlock(templateBlocks);
    ...
    if (customBlocks.length >= 1) {
      await import_coc6.workspace.jumpTo(doc.textDocument.uri, import_coc6.Position.create(customBlocks[0].start, customBlocks[0].end));
      if (scriptBlocks.length >= 1)
        await foldingSFCBlock(scriptBlocks);
      if (templateBlocks.length >= 1)
        await foldingSFCBlock(templateBlocks);
...
function useDocDescriptor() {
  ...
  const splitDocDescriptor = computed(() => shared2.parseSfc(splitDocText.value, htmlLs.parseHTMLDocument(TextDocument4.create("", "", 0, splitDocText.value))));
...
async function foldingSFCBlock(blockRanges) {
  for (const v of blockRanges) {
    await import_coc6.workspace.nvim.command(`${v.start + 1},${v.end + 1}fold`);
  }
}
...
function getCurrentTsPaths(context) {
  ...
  const builtinTsPaths = {
    serverPath: import_path.default.join(context.extensionPath, "node_modules", "typescript", "lib", "tsserverlibrary.js"),
    localizedPath
  };
...
var VolarCodeActionProvider = class {
  async provideCodeActions(document, range, context) {
    ...
    const wholeRange = import_coc9.Range.create(0, 0, doc.lineCount, 0);
    let whole = false;
    ...
    if (this.lineRange(range) && context.diagnostics.length > 0) {
      ...
      if (!thisLineContent.startsWith("//") && !thisLineContent.startsWith("/*") && !thisLineContent.startsWith("*") && existsVolarTsDiagnostics) {
        const edit = import_coc9.TextEdit.insert(import_coc9.Position.create(range.start.line, suppressLineLength), suppressLineNewText);
        codeActions.push({
...
function doctorCommand(context) {
  return async () => {
    ...
    if (!filePath.endsWith(".vue")) {
      return import_coc10.window.showInformationMessage("Failed to doctor. Make sure the current file is a .vue file.");
    }
    const clientJSON = import_path2.default.join(context.extensionPath, "package.json");
    const clientPackage = JSON.parse(import_fs2.default.readFileSync(clientJSON, "utf8"));
    const serverJSON = import_path2.default.join(context.extensionPath, "node_modules", "@volar", "server", "package.json");
    const serverPackage = JSON.parse(import_fs2.default.readFileSync(serverJSON, "utf8"));
    let vueVersion;
    let vueRuntimeDomVersion;
    let vueTscVersion;
    if (import_coc10.workspace.workspaceFolders) {
      for (const folder of import_coc10.workspace.workspaceFolders) {
        const pnpmPackagesDirNames = getDirectoryItemNames(import_path2.default.join(import_coc10.Uri.parse(folder.uri).fsPath, "node_modules", ".pnpm"));
        const vuePackageJsonPath = import_path2.default.join(import_coc10.Uri.parse(folder.uri).fsPath, "node_modules", "vue", "package.json");
        const vueRuntimeDomPackageJsonPath = import_path2.default.join(import_coc10.Uri.parse(folder.uri).fsPath, "node_modules", "@vue", "runtime-dom", "package.json");
        const vueTscVersionPackageJsonPath = import_path2.default.join(import_coc10.Uri.parse(folder.uri).fsPath, "node_modules", "vue-tsc", "package.json");
        if (import_fs2.default.existsSync(vuePackageJsonPath)) {
          vueVersion = getPackageVersionFromJson(vuePackageJsonPath);
        }
        if (import_fs2.default.existsSync(vueRuntimeDomPackageJsonPath)) {
        ...
        if (import_fs2.default.existsSync(vueTscVersionPackageJsonPath)) {
    ...
    if (tsServerPath) {
      const typescriptPackageJsonPath = import_path2.default.join(import_path2.default.resolve(import_path2.default.dirname(tsServerPath), ".."), "package.json");
      if (import_fs2.default.existsSync(typescriptPackageJsonPath)) {
        tsVersion2 = getPackageVersionFromJson(typescriptPackageJsonPath);
      }
    }
    const doctorData = {
      ...
      tsVersion: tsVersion2,
      tsServerPath,
      settings: import_coc10.workspace.getConfiguration("volar")
    };
    const outputText = JSON.stringify(doctorData, null, 2);
    await import_coc10.workspace.nvim.command("belowright vnew volar-doctor | setlocal buftype=nofile bufhidden=hide noswapfile filetype=json").then(async () => {
      const buf = await import_coc10.workspace.nvim.buffer;
...
function initializeTakeOverModeCommand() {
  return async () => {
    const enableTakeOverMode = await import_coc10.window.showPrompt("Enable TakeOverMode?");
    const config = import_coc10.workspace.getConfiguration("volar");
    const tsserverConfig = import_coc10.workspace.getConfiguration("tsserver");
...
function getPackageVersionFromJson(packageJsonPath) {
  let version;
  try {
    const packageJsonText = import_fs2.default.readFileSync(packageJsonPath, "utf8");
...
function getDirectoryItemNames(dirPath) {
  let a = [];
  try {
    a = import_fs2.default.readdirSync(dirPath);
  } catch {
    return void 0;
  }
  return a;
...
async function activate8(context, createLc) {
  initializeWorkspaceState(context);
  context.subscriptions.push(import_coc11.commands.registerCommand("volar.initializeTakeOverMode", initializeTakeOverModeCommand()));
  ...
  const clients = [apiClient, docClient, htmlClient].filter(shared4.notEmpty);
  registarRestartRequest();
  registarClientRequests();
  activate6(context);
  activate7(context, docClient != null ? docClient : apiClient);
  ...
  context.subscriptions.push(import_coc11.commands.registerCommand("volar.doctor", doctorCommand(context)));
...
function deactivate() {
  return Promise.all([apiClient == null ? void 0 : apiClient.stop(), docClient == null ? void 0 : docClient.stop(), htmlClient == null ? void 0 : htmlClient.stop()].filter(shared4.notEmpty));
}
...
function lowPowerModeEnabled() {
  return !!import_coc11.workspace.getConfiguration("volar").get("lowPowerMode");
}
function getConfigTagNameCase() {
  const tagNameCase = import_coc11.workspace.getConfiguration("volar").get("completion.tagNameCase");
  switch (tagNameCase) {
    case "both":
      return "both";
    case "kebab":
...
function getConfigAttrNameCase() {
  const tagNameCase = import_coc11.workspace.getConfiguration("volar").get("completion.attrNameCase");
  switch (tagNameCase) {
    case "kebab":
      return "kebabCase";
    case "camel":
...
async function activate9(context) {
  if (!getConfigVolarEnable())
    return;
  return activate8(context, (id, name, documentSelector, initOptions, port) => {
    let devVolarServerPath = getConfigDevServerPath();
    if (devVolarServerPath) {
      devVolarServerPath = import_coc12.workspace.expand(devVolarServerPath);
      if (fs3.existsSync(devVolarServerPath)) {
    ...
    const serverOptions = {
      run: {module: serverModule, transport: import_coc12.TransportKind.ipc},
      debug: {
        module: serverModule,
    ...
    const clientOptions = {
      ...
      synchronize: {
        fileEvents: import_coc12.workspace.createFileSystemWatcher("{**/*.vue,**/*.js,**/*.jsx,**/*.ts,**/*.tsx,**/*.json}")
      },
      middleware: getConfigFixCompletion() ? {
        provideCompletionItem: id === "volar-api" ? async (document, position, context2, token, next) => {
          const res = await Promise.resolve(next(document, position, context2, token));
          const doc = import_coc12.workspace.getDocument(document.uri);
          if (!doc || !res)
            return [];
          const items = res.hasOwnProperty("isIncomplete") ? res.items : res;
          return items;
        } : void 0
      } : void 0
    };
...
function getConfigVolarEnable() {
  return import_coc12.workspace.getConfiguration("volar").get("enable", true);
}
function getConfigDevServerPath() {
  return import_coc12.workspace.getConfiguration("volar").get("dev.serverPath", "");
}
function getConfigMaxMemory() {
  return import_coc12.workspace.getConfiguration("volar").get("maxMemory");
}
function getConfigFixCompletion() {
  return import_coc12.workspace.getConfiguration("volar").get("fix.completion", true);
}
