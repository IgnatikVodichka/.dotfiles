...
// node_modules/@volar/vue-language-server/out/protocol.js
var require_protocol2 = __commonJS({
  "node_modules/@volar/vue-language-server/out/protocol.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ParseSFCRequest = exports.GetConvertAttrCasingEditsRequest = exports.GetConvertTagCasingEditsRequest = exports.DetectNameCasingRequest = exports.GetComponentMeta = exports.GetVueCompilerOptionsRequest = void 0;
    var vscode = require_main2();
    var GetVueCompilerOptionsRequest;
    (function(GetVueCompilerOptionsRequest2) {
      GetVueCompilerOptionsRequest2.type = new vscode.RequestType("volar/vueCompilerOptions");
    })(GetVueCompilerOptionsRequest = exports.GetVueCompilerOptionsRequest || (exports.GetVueCompilerOptionsRequest = {}));
    var GetComponentMeta2;
    (function(GetComponentMeta3) {
      GetComponentMeta3.type = new vscode.RequestType("volar/meta");
    })(GetComponentMeta2 = exports.GetComponentMeta || (exports.GetComponentMeta = {}));
    var DetectNameCasingRequest;
    (function(DetectNameCasingRequest2) {
      DetectNameCasingRequest2.type = new vscode.RequestType("volar/detectTagCasing");
    ...
    (function(GetConvertTagCasingEditsRequest2) {
      GetConvertTagCasingEditsRequest2.type = new vscode.RequestType("volar/convertTagNameCasing");
    ...
    (function(GetConvertAttrCasingEditsRequest2) {
      GetConvertAttrCasingEditsRequest2.type = new vscode.RequestType("volar/convertAttrNameCasing");
    ...
    (function(ParseSFCRequest2) {
      ParseSFCRequest2.type = new vscode.RequestType("volar/parseSfc");
    })(ParseSFCRequest = exports.ParseSFCRequest || (exports.ParseSFCRequest = {}));
  }
});

// node_modules/@volar/vue-language-server/out/types.js
var require_types = __commonJS({
  "node_modules/@volar/vue-language-server/out/types.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var require_protocol3 = __commonJS({
  "node_modules/@volar/language-server/out/protocol.js"(exports) {
    ...
    (function(FsStatRequest2) {
      FsStatRequest2.type = new vscode.RequestType("fs/stat");
    })(FsStatRequest = exports.FsStatRequest || (exports.FsStatRequest = {}));
    var FsReadFileRequest;
    (function(FsReadFileRequest2) {
      FsReadFileRequest2.type = new vscode.RequestType("fs/readFile");
    ...
    (function(FsReadDirectoryRequest2) {
      FsReadDirectoryRequest2.type = new vscode.RequestType("fs/readDirectory");
    ...
    (function(WriteVirtualFilesNotification2) {
      WriteVirtualFilesNotification2.type = new vscode.NotificationType("volar.action.writeVirtualFiles");
    ...
    (function(ReloadProjectNotification3) {
      ReloadProjectNotification3.type = new vscode.NotificationType("volar.action.reloadProject");
    })(ReloadProjectNotification2 = exports.ReloadProjectNotification || (exports.ReloadProjectNotification = {}));
    var GetVirtualFileNamesRequest2;
    (function(GetVirtualFileNamesRequest3) {
      GetVirtualFileNamesRequest3.type = new vscode.RequestType("vue/virtualFileNames");
    })(GetVirtualFileNamesRequest2 = exports.GetVirtualFileNamesRequest || (exports.GetVirtualFileNamesRequest = {}));
    var GetVirtualFileRequest2;
    (function(GetVirtualFileRequest3) {
      GetVirtualFileRequest3.type = new vscode.RequestType("vue/virtualFile");
    })(GetVirtualFileRequest2 = exports.GetVirtualFileRequest || (exports.GetVirtualFileRequest = {}));
    var ReportStats2;
    (function(ReportStats3) {
      ReportStats3.type = new vscode.NotificationType0("vue/stats");
    })(ReportStats2 = exports.ReportStats || (exports.ReportStats = {}));
  }
});
...
var require_types2 = __commonJS({
  "node_modules/@volar/language-server/out/types.js"(exports) {
    ...
    })(ServerMode2 = exports.ServerMode || (exports.ServerMode = {}));
    ...
    })(DiagnosticModel2 = exports.DiagnosticModel || (exports.DiagnosticModel = {}));
  }
});

// node_modules/@volar/vue-language-core/out/types.js
var require_types3 = __commonJS({
  "node_modules/@volar/vue-language-core/out/types.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/@volar/vue-language-service/out/types.js
var require_types4 = __commonJS({
  "node_modules/@volar/vue-language-service/out/types.js"(exports) {
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
// node_modules/@volar/vue-language-server/out/index.js
var require_out = __commonJS({
  "node_modules/@volar/vue-language-server/out/index.js"(exports) {
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var import_vue_language_server2 = __toESM(require_out());
...
function doctorCommand(context) {
  return async () => {
    ...
    const serverJSON = import_path.default.join(
...
// src/requestTypes.ts
var import_vue_language_server = __toESM(require_out());
var coc = __toESM(require("coc.nvim"));
var ShowReferencesNotificationType = new coc.NotificationType(
  import_vue_language_server.ShowReferencesNotification.type.method
);
var FindFileReferenceRequestType = new coc.RequestType(import_vue_language_server.FindFileReferenceRequest.type.method);
var AutoInsertRequestType = new coc.RequestType(import_vue_language_server.AutoInsertRequest.type.method);
var ReloadProjectNotificationType = new coc.NotificationType(import_vue_language_server.ReloadProjectNotification.type.method);
var GetVirtualFileNamesRequestType = new coc.RequestType(import_vue_language_server.GetVirtualFileNamesRequest.type.method);
var GetVirtualFileRequestType = new coc.RequestType(import_vue_language_server.GetVirtualFileRequest.type.method);
var ReportStatsType = new coc.NotificationType(import_vue_language_server.ReportStats.type.method);
var GetComponentMetaType = new coc.RequestType(import_vue_language_server.GetComponentMeta.type.method);
...
// src/features/serverStatus.ts
var import_coc9 = require("coc.nvim");
async function register9(context, client) {
  context.subscriptions.push(
    import_coc9.commands.registerCommand("volar.action.serverStats", async () => {
...
async function activate(context, languageClient) {
  ...
  languageClient.onNotification(ShowReferencesNotificationType, (params) => {
    ...
    import_coc10.commands.executeCommand(
      "editor.action.showReferences",
      import_coc10.Uri.parse(uri),
      import_coc10.Position.create(pos.line, pos.character),
      refs.map(
        (ref) => import_coc10.Location.create(
          ref.uri,
          import_coc10.Range.create(ref.range.start.line, ref.range.start.character, ref.range.end.line, ref.range.end.character)
        )
      )
    );
  });
...
function getWorkspaceTsPaths(useDefault = false) {
  ...
  if (tsdk) {
    const tsPath = getWorkspaceTypescriptPath(
      tsdk,
      import_coc11.workspace.workspaceFolders.map((folder) => import_coc11.Uri.parse(folder.uri).fsPath)
    );
    if (tsPath) {
      return {
        tsdk: tsPath
...
function getConfigUseWorkspaceTsdk() {
  return import_coc11.workspace.getConfiguration("volar").get("useWorkspaceTsdk", false);
}
function getConfigCocTsserverTsdk() {
  return import_coc11.workspace.getConfiguration("tsserver").get("tsdk");
}

// src/features/virtualFiles.ts
var import_coc12 = require("coc.nvim");
async function register10(context, client) {
  await client.onReady();
  context.subscriptions.push(
    import_coc12.commands.registerCommand("volar.action.showVirtualFiles", async () => {
...
async function activate2(context, createLc) {
  register2(context);
  if (!activated) {
    const { document } = await import_coc13.workspace.getCurrentState();
    const currentLangId = document.languageId;
    if (currentLangId === "vue") {
      doActivate(context, createLc);
      activated = true;
    }
    if (!activated && currentLangId === "markdown" && processMd() || !activated && currentLangId === "html" && processHtml()) {
      doActivate(context, createLc);
      activated = true;
    }
  ...
  import_coc13.workspace.onDidOpenTextDocument(
    async () => {
      if (activated)
        return;
      const { document } = await import_coc13.workspace.getCurrentState();
...
async function doActivate(context, createLc) {
  ...
  [semanticClient, syntacticClient] = await Promise.all([
    createLc(
      "vue-semantic-server",
      "Vue Semantic Server",
      getDocumentSelector(import_vue_language_server2.ServerMode.Semantic),
      getInitializationOptions(import_vue_language_server2.ServerMode.Semantic, context),
      getFillInitializeParams([0 /* Semantic */]),
      6009
    ),
    createLc(
      "vue-syntactic-server",
      "Vue Syntactic Server",
      getDocumentSelector(import_vue_language_server2.ServerMode.Syntactic),
      getInitializationOptions(import_vue_language_server2.ServerMode.Syntactic, context),
      getFillInitializeParams([1 /* Syntactic */]),
      6011
    )
  ]);
  ...
  if (semanticClient) {
    ...
    if (import_coc13.workspace.getConfiguration("volar").get("autoCreateQuotes") || import_coc13.workspace.getConfiguration("volar").get("autoClosingTags") || import_coc13.workspace.getConfiguration("volar").get("autoCompleteRefs")) {
      register5(context, syntacticClient, semanticClient);
    }
    register10(context, semanticClient);
    register9(context, semanticClient);
    register6(context, semanticClient);
  }
  async function registerRestartRequest() {
    await Promise.all(clients.map((client) => client.onReady()));
    context.subscriptions.push(
      import_coc13.commands.registerCommand("volar.action.restartServer", async () => {
...
function takeOverModeEnabled() {
  return !!import_coc13.workspace.getConfiguration("volar").get("takeOverMode.enabled");
}
function getDocumentSelector(serverMode) {
  const takeOverMode = takeOverModeEnabled();
  const langs = takeOverMode ? ["vue", "javascript", "typescript", "javascriptreact", "typescriptreact"] : ["vue"];
  if (takeOverMode && serverMode === import_vue_language_server2.ServerMode.Semantic) {
    langs.push("json");
  }
  if (processHtml()) {
    langs.push("html");
...
function processHtml() {
  return !!import_coc13.workspace.getConfiguration("volar").get("vueserver.petiteVue.processHtmlFile");
}
function processMd() {
  return !!import_coc13.workspace.getConfiguration("volar").get("vueserver.vitePress.processMdFile");
}
function noProjectReferences() {
  return !!import_coc13.workspace.getConfiguration("volar").get("vueserver.noProjectReferences");
}
function reverseConfigFilePriority() {
  return !!import_coc13.workspace.getConfiguration("volar").get("vueserver.reverseConfigFilePriority");
}
function disableFileWatcher() {
  return !!import_coc13.workspace.getConfiguration("volar").get("vueserver.disableFileWatcher");
}
function diagnosticModel() {
  return import_coc13.workspace.getConfiguration("volar").get("vueserver.diagnosticModel");
}
function additionalExtensions() {
  return import_coc13.workspace.getConfiguration("volar").get("vueserver.additionalExtensions") ?? [];
}
function getFillInitializeParams(featuresKinds) {
  return function(params) {
    params.locale = import_coc13.workspace.getConfiguration("volar").get("tsLocale", "en");
    if (params.capabilities.textDocument) {
      if (!featuresKinds.includes(0 /* Semantic */)) {
        params.capabilities.textDocument.references = void 0;
        params.capabilities.textDocument.implementation = void 0;
        params.capabilities.textDocument.definition = void 0;
        params.capabilities.textDocument.typeDefinition = void 0;
        params.capabilities.textDocument.callHierarchy = void 0;
        params.capabilities.textDocument.hover = void 0;
        params.capabilities.textDocument.rename = void 0;
        params.capabilities.textDocument.signatureHelp = void 0;
        params.capabilities.textDocument.codeAction = void 0;
        params.capabilities.textDocument.completion = void 0;
        params.capabilities.textDocument.documentHighlight = void 0;
        params.capabilities.textDocument.documentLink = void 0;
        params.capabilities.textDocument.codeLens = void 0;
        params.capabilities.textDocument.semanticTokens = void 0;
        params.capabilities.textDocument.inlayHint = void 0;
        params.capabilities.textDocument.diagnostic = void 0;
      }
      if (!featuresKinds.includes(1 /* Syntactic */)) {
        params.capabilities.textDocument.selectionRange = void 0;
        params.capabilities.textDocument.foldingRange = void 0;
        params.capabilities.textDocument.linkedEditingRange = void 0;
        params.capabilities.textDocument.documentSymbol = void 0;
        params.capabilities.textDocument.colorProvider = void 0;
        params.capabilities.textDocument.formatting = void 0;
        params.capabilities.textDocument.rangeFormatting = void 0;
        params.capabilities.textDocument.onTypeFormatting = void 0;
      }
    }
    if (params.capabilities.workspace) {
      if (!featuresKinds.includes(0 /* Semantic */)) {
        params.capabilities.workspace.symbol = void 0;
        params.capabilities.workspace.fileOperations = void 0;
      }
    }
  };
}
function getInitializationOptions(serverMode, context) {
  ...
  const textDocumentSync = import_coc13.workspace.getConfiguration("volar").get("vueserver.textDocumentSync");
  const initializationOptions = {
    configFilePath: import_coc13.workspace.getConfiguration("volar").get("vueserver.configFilePath"),
    respectClientCapabilities: true,
    serverMode,
    diagnosticModel: serverMode === import_vue_language_server2.ServerMode.Syntactic ? import_vue_language_server2.DiagnosticModel.None : diagnosticModel() === "pull" ? import_vue_language_server2.DiagnosticModel.Pull : import_vue_language_server2.DiagnosticModel.Push,
    textDocumentSync: textDocumentSync ? {
      incremental: import_vscode_languageserver_protocol.TextDocumentSyncKind.Incremental,
      full: import_vscode_languageserver_protocol.TextDocumentSyncKind.Full,
      none: import_vscode_languageserver_protocol.TextDocumentSyncKind.None
    ...
    maxFileSize: import_coc13.workspace.getConfiguration("volar").get("vueserver.maxFileSize"),
    petiteVue: {
    ...
    json: {
      customBlockSchemaUrls: import_coc13.workspace.getConfiguration("volar").get("vueserver.json.customBlockSchemaUrls")
    },
...
async function activate3(context) {
  if (!getConfigVolarEnable())
    return;
  return activate2(context, (id, name, langs, initOptions, fillInitializeParams, port) => {
    ...
    const devVolarServerPath = import_coc14.workspace.expand(getConfigDevServerPath());
    if (devVolarServerPath && fs4.existsSync(devVolarServerPath)) {
      serverModule = devVolarServerPath;
    } else {
      serverModule = context.asAbsolutePath(
        path5.join("node_modules", "@volar", "vue-language-server", "bin", "vue-language-server.js")
      );
    }
    const maxOldSpaceSize = import_coc14.workspace.getConfiguration("volar").get("vueserver.maxOldSpaceSize");
    ...
    const serverOptions = {
      run: {
        module: serverModule,
        transport: import_coc14.TransportKind.ipc,
        options: runOptions
      },
      debug: {
        module: serverModule,
    ...
    const client = new import_coc14.LanguageClient(id, name, serverOptions, clientOptions);
...
function getConfigVolarEnable() {
  return import_coc14.workspace.getConfiguration("volar").get("enable", true);
}
function getConfigDisableProgressNotifications() {
  return import_coc14.workspace.getConfiguration("volar").get("disableProgressNotifications", false);
}
function getConfigDevServerPath() {
  return import_coc14.workspace.getConfiguration("volar").get("dev.serverPath", "");
}
function getConfigMiddlewareProvideCodeActionsEnable() {
  return import_coc14.workspace.getConfiguration("volar").get("middleware.provideCodeActions.enable", true);
}
function getConfigMiddlewareProvideCompletionItemEnable() {
  return import_coc14.workspace.getConfiguration("volar").get("middleware.provideCompletionItem.enable", true);
}
function getDisabledFeatures() {
  const disabledFeatures = [];
  if (import_coc14.workspace.getConfiguration("volar").get("disableDiagnostics")) {
    disabledFeatures.push("diagnostics");
  }
  if (import_coc14.workspace.getConfiguration("volar").get("disableFormatting")) {
