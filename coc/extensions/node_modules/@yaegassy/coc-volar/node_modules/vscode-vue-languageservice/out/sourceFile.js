...
function createSourceFile(uri, _content, _version, context) {
    ...
    const scriptSetupRanges = (0, reactivity_1.computed)(() => sfcScriptSetup.ast.value
        ...
        : undefined);
    const sfcScriptForTemplateLs = (0, useSfcScriptGen_1.useSfcScriptGen)('template', uri, document, (0, reactivity_1.computed)(() => descriptor.script), (0, reactivity_1.computed)(() => descriptor.scriptSetup), (0, reactivity_1.computed)(() => scriptRanges.value), (0, reactivity_1.computed)(() => scriptSetupRanges.value), sfcTemplateCompileResult, (0, reactivity_1.computed)(() => sfcStyles.textDocuments.value), context.compilerOptions.experimentalCompatMode === 2, !!context.compilerOptions.experimentalExposeScriptSetupContext);
