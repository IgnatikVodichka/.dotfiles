...
function useSfcScriptGen(lsType, vueUri, vueDoc, script, scriptSetup, scriptRanges, scriptSetupRanges, sfcTemplateCompileResult, sfcStyles, isVue2, exposeScriptSetupContext) {
    let version = 0;
    ...
    const codeGen = (0, reactivity_1.computed)(() => {
        var _a;
        return (0, script_1.generate)(lsType, vueUri, (_a = script.value) !== null && _a !== void 0 ? _a : undefined, scriptSetup.value ? { content: scriptSetup.value.content, exposeContext: exposeScriptSetupContext } : undefined, scriptRanges.value, scriptSetupRanges.value, () => htmlGen.value, () => {
            const bindTexts = [];
