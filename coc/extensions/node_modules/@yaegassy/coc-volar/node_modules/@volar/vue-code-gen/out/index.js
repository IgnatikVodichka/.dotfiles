 ...
 */
function generateSFCScriptTypeCheckCode(ts, scriptLang, scriptCode, scriptSetupCode, exposeScriptSetupContext, templateAst, cssVars, vueLibName = 'vue') {
    const generated = (0, script_1.generate)('script', '', scriptCode !== undefined ? { content: scriptCode } : undefined, scriptSetupCode !== undefined ? { content: scriptSetupCode, exposeContext: exposeScriptSetupContext } : undefined, scriptCode !== undefined ? (0, scriptRanges_1.parseScriptRanges)(ts, ts.createSourceFile('dummy.' + scriptLang, scriptCode, ts.ScriptTarget.ESNext), scriptSetupCode !== undefined, false, false) : undefined, scriptSetupCode !== undefined ? (0, scriptSetupRanges_1.parseScriptSetupRanges)(ts, ts.createSourceFile('dummy.' + scriptLang, scriptSetupCode, ts.ScriptTarget.ESNext)) : undefined, () => templateAst ? (0, template_scriptSetup_1.generate)(templateAst) : undefined, () => cssVars !== null && cssVars !== void 0 ? cssVars : [], vueLibName);
    return {
